...
const LoginPage = () => {
  ...
  return <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex w-1/2 bg-primary items-center justify-center p-8">
        <img alt="Login illustration" src="https://res.cloudinary.com/dz0b5eqof/image/upload/v1739981795/pexels-amar-30792659_w4yn8i.jpg" className="max-w-lg w-full h-auto object-cover" />
      </div>
    </div>;
};
